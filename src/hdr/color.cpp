...
ALLEGRO_COLOR color::index(u_char index)
{
    ...
    switch (index)
    {
        case color::darkredI  : color = color::darkred  ; break;
        ...
        case color::darkgreenI: color = color::darkgreen; break;
        case color::blueI     : color = color::blue     ; break;
        case color::darkblueI : color = color::darkblue ; break;
        case color::purpleI   : color = color::purple   ; break;
        case color::pinkI     : color = color::pink     ; break;
        case color::lightgrayI: color = color::lightgray; break;
        case color::grayI     : color = color::gray     ; break;
        case color::darkgrayI : color = color::darkgray ; break;
        case color::whiteI    : color = color::white    ; break;
        case color::beigeI    : color = color::beige    ; break;
        case color::brownI    : color = color::brown    ; break;
